...
def update_points_doubles(filename,p1,p1points,p2,p2points,winner,bonusplayer,gamest1,gamest2):
  ...
  if(df.at[p1index,'GamesWon']>0):
    df.at[p1index,'%games']=float(df.at[p1index,'GamesWon'])/float(df.at[p1index,'GamesTotal'])*100

  df.at[p2index,'GamesWon']=df.at[p2index,'GamesWon']+gamest2
  if(df.at[p2index,'GamesWon']>0):
    df.at[p2index,'%games']=float(df.at[p2index,'GamesWon'])/float(df.at[p2index,'GamesTotal'])*100
